...
\medskip
On définit une courbe elliptique sur un corps $K$ dans un plan par une équation cubique de la forme : 
\begin{equation*}
y^2 + a_1xy + a_3y  = x^3 + a_2x^2 + a_4x + a_6
\end{equation*}
Les coefficient $a_{1 \leq i \leq 6}$ sont des éléments du corps $K$.

Dans le cas ou le corps $K$ a une caractéristique différent de $2$ ou $3$ on peut via des changements de variable se ramener à l'équation suivante : 
\begin{equation*}
y^2 = x^3 + ax +b
\end{equation*}

\bigskip
Insérer des définitions pour discriminant j-invariant and co si jamais
\bigskip
Si on dispose de deux points $P$ et $Q$ appartenant à une courbe $E$ sur un corps $K$ on peut se demander ce que signifie l'addition de ces deux points.
