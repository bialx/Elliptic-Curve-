...
Ce théorème nous donne une méthode pour trouver toute les isogénies à une courbe elliptique $E$/$\mathbb{F}_p$. On va chercher les racines de $\Phi(j_E, y) \in \mathbb{F}_p[y]$ dans $\mathbb{F}_p$. Quand on trouve une racine on trouve un j-invariant d'une courbe $E_2$ isogène avec $E$.
